// PATH: src/features/admin/dashboard/DashboardPage.tsx
// IMPROVED: Real revenue charts (Recharts)
// IMPROVED: Revenue today + 30d stats
// IMPROVED: Consultation type breakdown pie chart
            ...
            <div className="card border-0 bg-success bg-opacity-10 h-100">
              <div className="card-body">
                ...
                <div className="text-muted small mt-1">
                  {stats?.consultations_today ?? 0} consultations today
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mt-4">
        ...
        <div className="row g-3">
          <QuickAction
            ...
            onClick={() => navigate('/admin/users')} color="primary"
          />
          <QuickAction
            icon="fa-user-astronaut" label="Manage Astrologers"
            description="Verify, update and monitor astrologers"
            onClick={() => navigate('/admin/astrologers')} color="success"
          />
          <QuickAction
            icon="fa-history" label="Activity Log"
            description="View user actions and system events"
            onClick={() => navigate('/admin/activity')} color="warning"
          />
        </div>
      </div>
