...
import 'admin-lte/dist/css/adminlte.min.css'; // FIX FE-G: static import instead of dynamic /node_modules/ path
...
import { useMyAstrologerProfileQuery,
         useToggleAvailabilityMutation } from '../../../store/astrologer.api';
...
export default function AstrologerLayout() {
  ...
  // Load AdminLTE JS on mount (CSS is now a static import above)
  // FIX FE-G: CSS was previously injected via /node_modules/ path which 404s in production
  useEffect(() => {
