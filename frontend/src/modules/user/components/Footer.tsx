          ...
          <div className="col-md-3">
            ...
            {subscribed ? (
              ...
              <div className="d-flex gap-2">
                ...
                <button className="btn btn-light btn-sm text-nowrap" onClick={handleSubscribe} disabled={subscribing}>
                  {subscribing ? <span className="spinner-border spinner-border-sm" /> : "Subscribe"}
                </button>
              </div>
            )}
