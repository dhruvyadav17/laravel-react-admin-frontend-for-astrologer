...
// IMPROVEMENT: Pehle sirf "Coming from API soon..." text tha — blank page
//              Ab proper placeholder cards hain — date picker + info sections
//              Jab API ready ho, sirf data replace karna hoga
...
/* ── Info card ───────────────────────────────────── */
function PanchangCard({ icon, title, value, color = "primary" }: {
  icon: string; title: string; value: string; color?: string;
}) {
  return (
  ...
  return (
    <UserPage title="📅 Panchang">
      ...
      <div className="text-center mb-4">
        <label className="form-label fw-semibold mb-2 d-block">Select Date</label>
        <input
          type="date"
      ...
      <div className="alert alert-info d-flex align-items-center gap-2 mb-4">
        ...
        <span>Live Panchang data integration is coming soon. Preview below shows structure.</span>
      </div>
        ...
        <div className="col-md-6">
          <div className="app-card">
            ...
            <div className="row text-center">
              ...
              <div className="col-6">
                <div className="text-muted small">Abhijit</div>
                <div className="fw-semibold">—</div>
              </div>
            </div>
          </div>
