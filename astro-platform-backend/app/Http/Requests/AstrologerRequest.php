<?php
// PATH: app/Http/Requests/AstrologerRequest.php
// UPDATE: consultation_type, is_available, gallery validation add kiye. Create vs update properly split.
// REASON: Pehle validation bahut basic tha — invalid data pass ho sakta tha.
