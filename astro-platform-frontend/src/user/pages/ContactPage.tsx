// PATH: src/user/pages/ContactPage.tsx
// NEW: Contact page — form UI + info, static
        ...
        <div className="col-md-4">
          <div className="app-card h-100">
            ...
            <div className="d-flex gap-2">
              {[
                { icon: "fa-instagram", color: "danger"  },
                { icon: "fa-youtube",   color: "danger"  },
                { icon: "fa-twitter",   color: "info"    },
                { icon: "fa-facebook",  color: "primary" },
              ].map(({ icon, color }) => (
                <button key={icon}
            ...
            {submitted ? (
              <div className="text-center py-4">
                ...
                <button className="btn btn-outline-secondary btn-sm"
                  onClick={() => { setSubmit(false); setForm({ name: "", email: "", subject: "", message: "" }); }}>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row g-3">
                    ...
                    <div className="col-sm-6">
                      ...
                      <input type="email" className="form-control" placeholder="rahul@email.com" required
                    ...
                    <div className="col-12">
                      ...
                      <textarea className="form-control" rows={5}
                        placeholder="Apna sawaal ya issue describe karein..." required
