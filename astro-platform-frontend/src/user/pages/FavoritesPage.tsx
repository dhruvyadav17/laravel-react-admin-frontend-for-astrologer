      ...
      {isLoading ? (
        ...
        <div className="text-center py-5">
          ...
          <p className="text-muted mb-4">
            Astrologers browse karte waqt heart icon click karein — woh yahan save honge.
          </p>
        ...
        <>
          <p className="text-muted mb-4">{saved.length} saved astrologer{saved.length !== 1 ? "s" : ""}</p>
