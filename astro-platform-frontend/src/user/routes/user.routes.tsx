...
// FIX: Unauthorized page mein <a href="/"> tha — full page reload
//      React Router ka <Link to="/"> use kiya
// No other changes needed — routes sahi hain
    ...
    },
    {
      ...
      element: (
        <div className="container py-5 text-center">
          ...
          {/* FIX: <a href> → <Link to> (SPA navigation) */}
